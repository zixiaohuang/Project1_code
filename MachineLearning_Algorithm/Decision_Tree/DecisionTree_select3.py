...
if __name__ == '__main__':
    with open('E:\\VgIndex2.py\\数据\\pca_data', 'rb') as f1:
        ...
        param_grid = [{'criterion': ['entropy'],'min_impurity_decrease': entropy_thresholds, 'max_depth': range(8, 13),
                'min_samples_split': range(2, 30, 2),'min_samples_leaf':range(1,4)},
              {'criterion': ['gini'],'min_impurity_decrease': gini_thresholds, 'max_depth': range(8, 13),
                'min_samples_split': range(2, 30, 2),'min_samples_leaf':range(1,4)}]
